...
// Modify Nullable Columns (dbDelta isn't always great at this)
echo "Checking nullable columns...\n";
$wpdb->query("ALTER TABLE {$wpdb->prefix}tsn_order_items MODIFY ticket_type_id BIGINT(20) UNSIGNED NULL");
$wpdb->query("ALTER TABLE {$wpdb->prefix}tsn_events MODIFY registration_mode VARCHAR(50) DEFAULT 'ticket'");
